    ...
    public partial class usuarios : System.Web.UI.Page
    {
        ...
        protected void SqlDataSourceUsuarios_Inserted(object sender, SqlDataSourceStatusEventArgs e)
        {
            if(e.Exception != null)
            {
                ...
                //lblMsg.Text = "Inserindo um registro duplicado ou com campos em branco";
        ...
        protected void SqlDataSourceUsuarios_Updated(object sender, SqlDataSourceStatusEventArgs e)
        {
            if (e.Exception != null)
            {
                Response.Write("<script> alert('Alterando um registro em informar todos os campos') </script>");
                //lblMsg.Text = "Alterando um registro em informar todos os campos";
                e.ExceptionHandled = true;
            }
        }
    }

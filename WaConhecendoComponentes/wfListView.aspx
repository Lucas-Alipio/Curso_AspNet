<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfListView.aspx.cs" Inherits="WaConhecendoComponentes.wfListView" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:ListView ID="ListView1" runat="server" DataKeyNames="Id" DataSourceID="SqlDataSourceListView" InsertItemPosition="LastItem">
            ...
            <asp:SqlDataSource ID="SqlDataSourceListView" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 

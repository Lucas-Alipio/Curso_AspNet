...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <br />
    <asp:TextBox ID="txbNome" runat="server" Width="470px"></asp:TextBox>
    <br />
    <br />
    <asp:Label ID="Label4" runat="server" Text="Email:"></asp:Label>
    <br />
    <asp:TextBox ID="txbEmail" runat="server" Width="470px"></asp:TextBox>
    <br />
    <br />
    <asp:Label ID="Label5" runat="server" Text="Telefone:"></asp:Label>
    <br />
    <asp:TextBox ID="txbTelefone" runat="server" Width="390px"></asp:TextBox>
&nbsp;<asp:Button ID="btnInserir" runat="server" OnClick="btnInserir_Click" Text="Inserir" Width="75px" />
    <br />
    <br />
    <br />
    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Larger" Text="Lista de Contatos"></asp:Label>
    <br />
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False" CellPadding="3" DataKeyNames="Id" DataSourceID="SqlDataSourceContatos" ForeColor="Black" GridLines="Vertical" Width="818px" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px">
